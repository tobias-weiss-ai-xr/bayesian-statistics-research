...
Data-driven, auto-validated literature review corpus for **Bayesian statistics**
(inference, computation, prior modeling, model selection, hierarchical and
nonparametric Bayes, Bayesian deep learning, applications): papers live in
`papers.yaml`, everything else is generated.
